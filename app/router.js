...
module.exports = app => {
  ...
  const catchError = middleware.catchError();
  router.get('/', controller.home.index);
  router.post('/api/user/login', controller.user.login);
  router.post('/api/user/logout', controller.user.logout);
  router.post('/api/user/queryProvinceByProvinceName', validLogin, catchError, controller.user.queryProvinceByProvinceName);
